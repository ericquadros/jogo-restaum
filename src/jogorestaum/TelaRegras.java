...
public class TelaRegras extends JFrame {
	...
	public TelaRegras(){
		...
		msg += "\nComo jogar: ";
		msg += "  No início do jogo é organizado no tabuleiro um total de 32  peças, em um tabuleiro com a forma de um sinal de “+” (mais ou adição) e ficando livre o espaço central (O tabuleiro possui um total de Trinta e três peças).";
